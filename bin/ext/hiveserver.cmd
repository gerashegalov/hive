...
@echo   ^<arguments^>%HADOOP_OPTS% %AUX_PARAM% -classpath %CLASSPATH% %CLASS% -hiveconf hive.hadoop.classpath=%HIVE_LIB%\* -hiveconf hive.metastore.local=true -hiveconf hive.server.servermode=http -p 10000 %HIVE_OPTS%^</arguments^>
@echo ^</service^>
goto :EOF
